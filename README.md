...
If it cannot handle 100 records, you probably need to sign up for a payment plan. Please check the app's information on how much data it can handle for each payment plan.
